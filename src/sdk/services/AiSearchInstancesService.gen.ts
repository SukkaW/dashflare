...
export class AiSearchInstancesService {
    ...
    public static aiSearchCreateInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).post<AiSearchCreateInstanceResponses, AiSearchCreateInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: zAiSearchCreateInstanceBody.optional(),
                path: zAiSearchCreateInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchCreateInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchDeleteInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).delete<AiSearchDeleteInstanceResponses, AiSearchDeleteInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zAiSearchDeleteInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchDeleteInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchFetchInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).get<AiSearchFetchInstanceResponses, AiSearchFetchInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zAiSearchFetchInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchFetchInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchUpdateInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).put<AiSearchUpdateInstanceResponses, AiSearchUpdateInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: zAiSearchUpdateInstanceBody.optional(),
                path: zAiSearchUpdateInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchUpdateInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchNamespaceCreateInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).post<AiSearchNamespaceCreateInstanceResponses, AiSearchNamespaceCreateInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: zAiSearchNamespaceCreateInstanceBody.optional(),
                path: zAiSearchNamespaceCreateInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchNamespaceCreateInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchNamespaceDeleteInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).delete<AiSearchNamespaceDeleteInstanceResponses, AiSearchNamespaceDeleteInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zAiSearchNamespaceDeleteInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchNamespaceDeleteInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchNamespaceFetchInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).get<AiSearchNamespaceFetchInstanceResponses, AiSearchNamespaceFetchInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zAiSearchNamespaceFetchInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchNamespaceFetchInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
    ...
    public static aiSearchNamespaceUpdateInstance<ThrowOnError extends boolean = true>(parameters: {
        ...
        return (options?.client ?? client).put<AiSearchNamespaceUpdateInstanceResponses, AiSearchNamespaceUpdateInstanceErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: zAiSearchNamespaceUpdateInstanceBody.optional(),
                path: zAiSearchNamespaceUpdateInstancePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zAiSearchNamespaceUpdateInstanceResponse.parseAsync(data),
            security: [
                { scheme: 'bearer', type: 'http' },
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' }
