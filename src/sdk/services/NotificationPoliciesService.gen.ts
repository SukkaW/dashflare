...
export class NotificationPoliciesService {
     ...
     */
    public static notificationPoliciesShowEmailUnsubscribeDetails<ThrowOnError extends boolean = true>(parameters: {
        account_id: AaaAccountId;
        policy_id: AaaPolicyId;
        email: string;
        token: string;
        ...
        return (options?.client ?? client).get<NotificationPoliciesShowEmailUnsubscribeDetailsResponses, NotificationPoliciesShowEmailUnsubscribeDetailsErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zNotificationPoliciesShowEmailUnsubscribeDetailsPath,
                query: zNotificationPoliciesShowEmailUnsubscribeDetailsQuery
            }).parseAsync(data),
            responseValidator: async (data) => await zNotificationPoliciesShowEmailUnsubscribeDetailsResponse.parseAsync(data),
     ...
     */
    public static notificationPoliciesUnsubscribeEmailFromNotificationPolicy<ThrowOnError extends boolean = true>(parameters: {
        account_id: AaaAccountId;
        policy_id: AaaPolicyId;
        email: string;
        token: string;
        ...
        return (options?.client ?? client).post<NotificationPoliciesUnsubscribeEmailFromNotificationPolicyResponses, NotificationPoliciesUnsubscribeEmailFromNotificationPolicyErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zNotificationPoliciesUnsubscribeEmailFromNotificationPolicyPath,
                query: zNotificationPoliciesUnsubscribeEmailFromNotificationPolicyQuery
            }).parseAsync(data),
            responseValidator: async (data) => await zNotificationPoliciesUnsubscribeEmailFromNotificationPolicyResponse.parseAsync(data),
            url: '/accounts/{account_id}/alerting/v3/policies/{policy_id}/email/unsubscribe',
            ...options,
            ...params
        });
