...
export class BrapiService {
     ...
     */
    public static brapiGetDevtoolsJsonClose<ThrowOnError extends boolean = true>(parameters: {
        session_id: string;
        account_id: string;
        target_id: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? client).get<BrapiGetDevtoolsJsonCloseResponses, BrapiGetDevtoolsJsonCloseErrors, ThrowOnError>({
            requestValidator: async (data) => await z.object({
                body: z.never().optional(),
                path: zBrapiGetDevtoolsJsonClosePath,
                query: z.never().optional()
            }).parseAsync(data),
            responseValidator: async (data) => await zBrapiGetDevtoolsJsonCloseResponse.parseAsync(data),
            security: [
                { name: 'X-Auth-Email', type: 'apiKey' },
                { name: 'X-Auth-Key', type: 'apiKey' },
                { scheme: 'bearer', type: 'http' }
            ],
            url: '/accounts/{account_id}/browser-rendering/devtools/browser/{session_id}/json/close/{target_id}',
            ...options,
            ...params
        });
    }
