...
export class RadarTopLevelDomainsService {
    ...
    public static radarGetTlds<ThrowOnError extends boolean = true>(parameters?: {
        ...
        tld?: string;
        format?: 'JSON' | 'CSV';
    }, options?: Options<never, ThrowOnError>): RequestResult<RadarGetTldsResponses, RadarGetTldsErrors, ThrowOnError> {
    ...
    public static radarGetTldsPerformanceSummary<ThrowOnError extends boolean = true>(parameters: {
        ...
        format?: 'JSON' | 'CSV';
    }, options?: Options<never, ThrowOnError>): RequestResult<RadarGetTldsPerformanceSummaryResponses, RadarGetTldsPerformanceSummaryErrors, ThrowOnError> {
        const params = buildClientParams([parameters], [{ args: [
    ...
    public static radarGetTldsPerformanceTimeseriesGroups<ThrowOnError extends boolean = true>(parameters: {
        ...
        limitPerGroup?: number;
        format?: 'JSON' | 'CSV';
    }, options?: Options<never, ThrowOnError>): RequestResult<RadarGetTldsPerformanceTimeseriesGroupsResponses, RadarGetTldsPerformanceTimeseriesGroupsErrors, ThrowOnError> {
        const params = buildClientParams([parameters], [{ args: [
                    { in: 'path', key: 'dimension' },
    ...
    public static radarGetTldDetails<ThrowOnError extends boolean = true>(parameters: {
        tld: string;
        format?: 'JSON' | 'CSV';
    }, options?: Options<never, ThrowOnError>): RequestResult<RadarGetTldDetailsResponses, RadarGetTldDetailsErrors, ThrowOnError> {
